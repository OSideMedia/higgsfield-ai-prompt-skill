...
- Soul ID character consistency guidance
...
└── mnt/user-data/outputs/higgsfield/
    ...
    └── skills/
        ...
        ├── higgsfield-cinema/SKILL.md      ← Cinema Studio 2.0
...
Built February 2026 · v1.4.0 (updated March 2026) · Platform: [higgsfield.ai](https://higgsfield.ai)
