...
- **13,626 generations for one ~2–3-minute short** (the "4K Blockbuster Breakdown" flagship, made solo). Of the sampled jobs, only ~16 final Seedance videos shipped per scene — an iteration ratio of roughly **50–100 generations per kept shot**, consistent with the Hell Grind 1.0–1.5% acceptance band.
